...
<body>
	...
	<section id="container">
        ...
        <a href="nueva_venta.php" class="btn_new btn_new_venta"><i class="fas fa-plus"></i> Nueva Venta</a>

        <!-- formulario para el buscador-->
        <form action="../modelo/buscar_venta.php" method="GET" class="form_search">
            <input type="text" name="busqueda" id="busqueda" placeholder="No. factura" class="input_search">
            <!--<input type="submit" value="Buscar" class="btn_search">-->
            <button type="submit" class="btn_search"><i class="fas fa-search"></i></button>
        </form>

        <a href="../controlador/excel5.php" class="btn_new adap excel">Descargar Excel</a>

        <div>
            <h5 class="date_title">Buscar por fecha</h5>
            <form action="../modelo/buscar_venta.php" method="get" class="form_search_date">
                <label>De: </label>
    ...
    <div class="containerTable">
        ...
        <?php 
            ...
            $sql_register = mysqli_query($conection, "SELECT COUNT(*) AS total_register FROM factura WHERE estatus != 10");
                    ...
                    <tr id="row_<?php echo $data["nofactura"];?>">
                        ...
                        <td>
                            <div class="div_acciones">
                                ...
                                <form action="../modelo/sistema/enviar-prueba.php" method="POST" class="enviar_fac">
                                    <input type="hidden" name="cl" value="<?php echo $data["codcliente"];?>">
                                    <input type="hidden" name="f" value="<?php echo $data["nofactura"];?>">
                                    <div class="div_factura">
                                        <button type="submit" class="btn_anular enviar" name="enviar_fact"><i class="fas fa-share"></i></button>
                                    </div> 
                                </form> 
                                <?php   }else{?>
                                <div class="div_factura">
                                ...
                                <form action="../modulo/sistema/enviar-prueba.php" method="POST" class="enviar_fac">
                                    <div class="div_factura">
                                        <button type="button" class="btn_anular enviar inactive" name="enviar_fact"><i class="fas fa-share"></i></button>
                                    </div> 
                                </form>    
                                <?php   }
                                    }?> 
