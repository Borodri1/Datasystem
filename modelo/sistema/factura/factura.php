...
<div id="page_pdf">
	<table id="factura_head">
		<tr>
			<td class="logo_factura">
				<div class="logo-img">
					<img src="http://<?php echo $_SERVER['HTTP_HOST'];?>/dataSystem/modelo/sistema/factura/img/logo.png" alt="" style="width: 100px;">
					<!--<img src="https://es.wikipedia.org/wiki/Imagen_Televisi%C3%B3n#/media/Archivo:Logo_Imagen_Televisi%C3%B3n_2016.png">-->
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						...
						<tr>
							<td><label>Suburbio:</label> <p><?php echo $factura['suburbio']; ?></p></td>
							<td><label>Codigo postal:</label> <p><?php echo $factura['codigo_postal']; ?></p></td>
						</tr>
					</table>
				</div>
			</td>
	...
	<table id="factura_detalle">
			...
			<tfoot id="detalle_totales">
				<tr>
					<td colspan="3" class="textright"><span>SUBTOTAL $AUD.</span></td>
				...
				<tr>
					<td colspan="3" class="textright"><span>TOTAL $AUD.</span></td>
