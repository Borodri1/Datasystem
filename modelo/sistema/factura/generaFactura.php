<?php
	...
	require_once '../pdf/vendor/dompdf/dompdf/autoload.inc.php';
	...
	if(empty($_REQUEST['cl']) || empty($_REQUEST['f']))
	{
		...
		if($result > 0){
			...
			if($factura['estatus'] == 2){
				...
				//$anulada = '<img src="http://localhost/proyectodegrado1/sistema/factura/img/anulado.png" alt="anulada" class="anulada">';

				$texto = '<img src="http://';
				$texto2 = '/dataSystem/modelo/sistema/factura/img/anulado.png" alt="anulada" class="anulada">';
				$anulada = $texto.$_SERVER['HTTP_HOST'].$texto2;
			}			
