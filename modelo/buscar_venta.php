...
<body>
	...
	<section id="container">
        ...
        <a href="../vista/nueva_venta.php" class="btn_new btn_new_venta"><i class="fas fa-plus"></i> Nueva Venta</a>

        <!-- formulario para el buscador-->
        <form action="buscar_venta.php" method="GET" class="form_search">
            <input type="text" name="busqueda" id="busqueda" placeholder="No. factura" class="input_search" value="<?php echo $busqueda;?>">
    ...
    <div class="containerTable">
        ...
        <?php 
            ...
            $sql_register = mysqli_query($conection, "SELECT COUNT(*) AS total_register FROM factura WHERE $where");
